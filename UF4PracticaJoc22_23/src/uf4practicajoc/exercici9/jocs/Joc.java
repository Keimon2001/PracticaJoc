package uf4practicajoc.exercici9.jocs;

import uf4practicajoc.exercici8.jocs.*;
...
public abstract class Joc {
    ...
    /**
     *
     * @return Retorna true en cas que tinguem 1 o mes vides,
     *         Retorna false en cas que ens quedem amb 0 vides.
     * Métode per a treure 1 vida.
     */
     ...
     *
     * @param joc 
     * Métode per actualitzar el record en cas que les vides siguin mes grans que el record.
     * I tambe per a mostrar aconseguit el record en cas que siguin iguals.
     */
